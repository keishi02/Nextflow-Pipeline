...
if (not sys.argv[1] == "all"):
    df_mellifera = df_mellifera.head(int(sys.argv[1]))
...
for i in range(len(df_mellifera1)):
    ...
    #call shell script
    subprocess.call(['/depot/bharpur/data/projects/keishi/alignment_2_links.sh', var1, var2, var3])
...
for i in range(len(df_mellifera2)):
    ...
    #call shell script
    subprocess.call(['/depot/bharpur/data/projects/keishi/alignment_1_link.sh', var1, var2])
